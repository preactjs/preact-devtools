!(function (n, t) {
	...
	function F(n) {
		return U(n) ? e.cloneElement.apply(null, arguments) : n;
	}
	function j(n) {
			...
			if (
				...
				if (u)
					for (o in ((i = n.props = {}), r))
						i[x.test(o) ? o.replace(/[A-Z0-9]/, "-$&").toLowerCase() : o] =
							r[o];
			}
			!(function (t) {
				var e = n.type,
				...
				if (r && "string" == typeof e) {
					...
					if (
						...
						u.onbeforeinput &&
							((r.onbeforeinput = r[u.onbeforeinput]),
							delete r[u.onbeforeinput]),
						u.onchange &&
							("textarea" === e ||
				...
				"function" == typeof t &&
					!t.m &&
					t.prototype &&
					(S(t.prototype, "componentWillMount"),
					S(t.prototype, "componentWillReceiveProps"),
					S(t.prototype, "componentWillUpdate"),
					(t.m = !0));
		}
		N && N(n);
	};
