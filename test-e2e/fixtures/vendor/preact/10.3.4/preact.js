	...
	if (
		...
		"o" === l[0] && "n" === l[1]
			? ((e = l !== (l = l.replace(/Capture$/, ""))),
			  ...
			  u
					? (i || n.addEventListener(l, z, e), ((n.l || (n.l = {}))[l] = u))
					: n.removeEventListener(l, z, e))
			: "list" !== l &&
			  "tagName" !== l &&
			  "form" !== l &&
			  "type" !== l &&
...
function L(n, l) {
	return (
		...
		p(n.type, l, l.key || n.key, l.ref || n.ref)
	);
}
function M(n) {
	var l = {},
