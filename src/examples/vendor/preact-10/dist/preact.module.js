	...
	try {
		n: if ('function' == typeof P) {
			...
			(h.context = C),
				...
				(u.__k = b(
					null != a && a.type == d && null == a.key ? a.props.children : a
				)),
...
function j(n, l, u, t, i, o, r, c) {
	...
	if (null === l.type)
		...
		if (
			...
			(h = (d = u.props || f).dangerouslySetInnerHTML),
