...
function y(n, l) {
	if (null == l) return n.__ ? y(n.__, n.__.__k.indexOf(n) + 1) : null;
...
function g(n, l, u, t, i, o, r, c, s) {
	var p,
		...
		_ = g.length;
	if (
		(c == f && (c = null != o ? o[0] : _ ? y(u, 0) : null),
		(p = 0),
		(l.__k = k(l.__k, function(u) {
			if (null != u) {
				if (
					((u.__ = l),
					(u.__b = l.__b + 1),
					null === (v = g[p]) || (v && u.key == v.key && u.type === v.type))
				)
					g[p] = void 0;
				else
					for (h = 0; h < _; h++) {
				...
				if (
					((d = N(n, u, (v = v || f), t, i, o, r, c, s)),
					(h = u.ref) &&
						v.ref != h &&
						(w || (w = []),
						v.ref && w.push(v.ref, null, u),
						w.push(h, u.__c || d, u)),
					null != d)
				) {
					if ((null == x && (x = d), null != u.__d))
						(d = u.__d), (u.__d = null);
					else if (o == v || d != c || null == d.parentNode) {
		...
		for (p = o.length; p--; ) null != o[p] && a(o[p]);
	for (p = _; p--; ) null != g[p] && z(g[p], g[p]);
	if (w) for (p = 0; p < w.length; p++) j(w[p], w[++p], w[++p]);
}
function k(n, l, u) {
	if ((null == u && (u = []), null == n || 'boolean' == typeof n))
		l && u.push(l(null));
	else if (Array.isArray(n)) for (var t = 0; t < n.length; t++) k(n[t], l, u);
	else
		u.push(
			l
				? l(
	...
	if (
		...
		if (((o = n.style), 'string' == typeof u)) o.cssText = u;
			...
			if (('string' == typeof t && ((o.cssText = ''), (t = null)), t))
				for (r in t) (u && r in u) || b(o, r, '');
			if (u) for (f in u) (t && u[f] === t[f]) || b(o, f, u[f]);
		}
	else
		'o' === l[0] && 'n' === l[1]
			? ((e = l !== (l = l.replace(/Capture$/, ''))),
			  ...
			  u
					? (t || n.addEventListener(l, P, e), ((n.l || (n.l = {}))[l] = u))
					: n.removeEventListener(l, P, e))
...
function N(l, u, t, i, o, r, f, e, c) {
	...
	try {
		n: if ('function' == typeof P) {
			if (
				((_ = u.props),
				(b = (a = P.contextType) && i[a.__c]),
				(C = a ? (b ? b.props.value : a.__) : i),
				t.__c
				...
				null != P.getDerivedStateFromProps &&
					(p.__s == p.state && (p.__s = s({}, p.__s)),
					s(p.__s, P.getDerivedStateFromProps(_, p.__s))),
				(y = p.props),
				(m = p.state),
				h)
			)
				...
				if (
					(null == P.getDerivedStateFromProps &&
						...
						p.componentWillReceiveProps(_, C),
					!p.__e &&
						null != p.shouldComponentUpdate &&
						!1 === p.shouldComponentUpdate(_, p.__s, C))
				) {
					for (
						p.props = _,
							p.state = p.__s,
				...
				null != p.componentWillUpdate && p.componentWillUpdate(_, p.__s, C),
					null != p.componentDidUpdate &&
						p.__h.push(function() {
							p.componentDidUpdate(y, m, x);
						});
			}
			(p.context = C),
				(p.props = _),
				...
				(u.__k = k(
					null != a && a.type == v && null == a.key ? a.props.children : a
				)),
				null != p.getChildContext && (i = s(s({}, i), p.getChildContext())),
				h ||
					null == p.getSnapshotBeforeUpdate ||
					(x = p.getSnapshotBeforeUpdate(y, m)),
				g(l, u, t, i, o, r, f, e, c),
				(p.base = u.__e),
				p.__h.length && f.push(p),
				w && (p.__E = p.__ = null),
				(p.__e = null);
		} else u.__e = $(t.__e, u, t, i, o, r, f, c);
		(a = n.diffed) && a(u);
	} catch (l) {
		n.__e(l, u, t);
	}
...
function $(n, l, u, t, i, o, r, c) {
	...
	if (null === l.type)
		...
		if (
			...
			(p = (d = u.props || f).dangerouslySetInnerHTML),
			...
			(h || p) &&
				((h && p && h.__html == p.__html) ||
					(n.innerHTML = (h && h.__html) || ''));
		}
		_(n, y, d, i, c),
			(l.__k = l.props.children),
			h || g(n, l, u, t, 'foreignObject' !== l.type && i, o, r, f, c),
			c ||
				('value' in y &&
					void 0 !== y.value &&
					y.value !== n.value &&
...
function z(l, u, t) {
	...
	if ((i = l.__k)) for (r = 0; r < i.length; r++) i[r] && z(i[r], u, t);
	null != o && a(o);
}
function A(n, l, u) {
...
function D(l, u, t) {
	...
	n.__ && n.__(l, u),
		...
		N(
			...
			t && !i ? [t] : r ? null : e.slice.call(u.childNodes),
			c,
			t || f,
			i
		),
...
(n = {
	...
	(d.prototype.setState = function(n, l) {
		...
		(u = this.__s !== this.state ? this.__s : (this.__s = s({}, this.state))),
			...
			null != n &&
				this.__v &&
				((this.__e = !1), l && this.__h.push(l), x(this));
	}),
	(d.prototype.forceUpdate = function(n) {
		this.__v && ((this.__e = !0), n && this.__h.push(n), x(this));
	}),
	(d.prototype.render = v),
	(u = []),
	(t =
